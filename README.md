...
[![Portfolio](https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&logo=vercel&logoColor=white)](https://spandan-das.onrender.com/)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/spandan-das-b7b5a431b)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:dasspandan2106@gmail.com)
...
<a href="https://github.com/Spandan2106/Spandan2106/raw/main/Spandan_Das_CV.pdf">
  <img src="https://img.shields.io/badge/⬇️_Download_CV-0f2027?style=for-the-badge&logo=readdotcv&logoColor=white" />
</a>

<img src="https://komarev.com/ghpvc/?username=Spandan2106&style=for-the-badge&color=00C9A7&label=PROFILE+VIEWS" />
...
**🛒 [WE_SELL — E-Commerce Platform](https://wesellcom.vercel.app/)**
Handles 500+ concurrent users with real-time inventory sync and recommendations; 30% latency reduction via MongoDB indexing.
`React` `Node.js` `Express.js` `MongoDB`

</td>
<td width="50%">

**💬 [Chat_Z — Real-Time Chat App](https://chat-z.vercel.app/)**
Private/group messaging with multimedia sharing over low-latency Socket.io channels.
...
**🤖 [Jarvis — AI Chatbot](https://ai-chatbot-lrjc.onrender.com/)**
Gemini-API-powered conversational chatbot with sub-2-second response times.
`Next.js` `TypeScript` `Express.js`

</td>
<td width="50%">

**🔗 [Metropolis E-Voting](https://metropolis-evoting-2026.onrender.com/)**
Decentralized voting system using SHA-256 hashing for tamper-proof recordkeeping.
...
**🗺️ [Urban Planning — Graph Coloring App](https://github.com/Spandan2106/Urban-planning-web-application-2026)**
Python/Streamlit tool that assigns administrative categories to neighboring regions via graph coloring — see details below.
`Python` `Streamlit` `NetworkX` `MongoDB`

</td>
<td width="50%">

**📚 [Library Management System](https://library-management-system-dwu0.onrender.com/)**
Book cataloging, user management, and borrowing-history tracking.
...
|---|---|---|---|
| Hologram Engine | Immersive 3D browser visualization with hand-gesture & voice control | React.js, Three.js | [Demo](https://future-idea-2025.vercel.app/) |
| COA Visualizer | CPU architecture visualization tool adopted by peers for exam prep | TypeScript, React | [Demo](https://coa-visualizer-2026.vercel.app/) |
| OmniConvert | Multi-domain unit converter: currency, timezone, measurements, calculator, graphing | TypeScript, React | [Demo](https://omniconveter.vercel.app/) |
...
[![LeetCode](https://leetcard.jacoblin.cool/Spandan_Das?theme=dark&font=monsterrat&ext=heatmap)](https://leetcode.com/Spandan_Das/)

<img src="https://codeforces-readme-stats.vercel.app/api/card?username=Spandan2025" width="45%"/>
<img src="https://codeforces-readme-stats.vercel.app/api/badge?username=Spandan2025" width="45%"/>
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/spandan-das-b7b5a431b)
[![Portfolio](https://img.shields.io/badge/Portfolio-2C5364?style=for-the-badge&logo=vercel&logoColor=white)](https://spandan-das.onrender.com/)
